Vintasoft.Imaging.Ocr.dll assembly is the assembly from VintaSoft OCR .NET Plug-in and
it contains classes for management of optical character recognition (OCR) engines.
...
GENERAL FEATURES:
- The plug-in can be used for developing .NET 5 and Core 3.1 applications (console, WPF, WinForms, ASP.NET Core, service, etc) for Windows
...
ONLINE RESOURCES:
1. Product web page: https://www.vintasoft.com/vsocr-dotnet-index.html?referer=nuget.org/Vintasoft.Imaging.Ocr
2. Online FAQ: https://www.vintasoft.com/vsimaging-dotnet-faq.html?referer=nuget.org/Vintasoft.Imaging.Ocr
3. Online Developer's Guide and API Reference: https://www.vintasoft.com/docs/vsimaging-dotnet/
4. Online code examples: https://www.vintasoft.com/vsimaging-dotnet-examples.html?referer=nuget.org/Vintasoft.Imaging.Ocr
5. Online Support Center: https://www.vintasoft.com/support/

6. Articles:
- Recognize text in image: https://www.vintasoft.com/docs/vsimaging-dotnet/Programming-Ocr-Overview.html?referer=nuget.org/Vintasoft.Imaging.Ocr
- How to convert TIFF file to searchable PDF document: https://www.vintasoft.com/docs/vsimaging-dotnet/Programming-OCR-How_To_Tiff_To_Searchable_Pdf.html?referer=nuget.org/Vintasoft.Imaging.Ocr
- How to acquire image from scanner and generate searchable PDF document: https://www.vintasoft.com/docs/vsimaging-dotnet/Programming-OCR-How_To_Scan_To_Searchable_Pdf.html?referer=nuget.org/Vintasoft.Imaging.Ocr
